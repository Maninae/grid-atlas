...
export const FUELS = {
  ...
  wind:       { label: "Wind",       color: "#85D0E3", emoji: "🌬️", clean: true,
                blurb: "Tall turbines spun by moving air." },
  hydro:      { label: "Hydro",      color: "#3D7BBE", emoji: "💧", clean: true,
  ...
  geothermal: { label: "Geothermal", color: "#C25B6A", emoji: "♨️", clean: true,
  ...
  coal:       { label: "Coal",       color: "#756C61", emoji: "⛏️", clean: false,
  ...
  other:      { label: "Other",      color: "#98A39A", emoji: "⚡", clean: false,
